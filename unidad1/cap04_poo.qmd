...
Un solo cambio (`BonoLocal.mercado = "MAE"`) y las dos instancias lo ven — esa es la utilidad: constantes y configuración compartida viven en la clase, datos propios de cada objeto viven en la instancia. La trampa clásica asociada (un atributo de clase **mutable**, como una lista) te espera en los Errores comunes.
