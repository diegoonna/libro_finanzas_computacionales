...
5. **HRP con datos reales**: descargá retornos de 8–10 acciones de distintos sectores, corré el pipeline completo y analizá si el dendrograma recupera los sectores.
:::
...
* López de Prado, M. (2018). *Advances in Financial Machine Learning*. Wiley. [Capítulo 16].
* Raffinot, T. (2017). *Hierarchical Clustering-Based Asset Allocation*. The Journal of Portfolio Management.
